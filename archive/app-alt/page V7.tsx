...
export default function Home() {
  ...
  const planningContext = useMemo(() => buildPlanningContext(plannerRequest), [plannerRequest]);
  ...
  }, [locations, planningContext]);

  const slots = useMemo(() => {
    return buildSlotTemplate({
      planMode,
      stopsCount: planMode === "fullday" ? 7 : clamp(stopsCount, 1, 3),
      fullDayActsAfterBreakfast,
      fullDayActsAfterLunch,
    });
  ...
  }, [planningContext, results, planMode, stopOffsets]);
