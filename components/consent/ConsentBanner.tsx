...
export default function ConsentBanner() {
  ...
  return (
    <div
      className={[
        "fixed bottom-0 left-0 right-0 z-[200] px-3 pb-[5.4rem] pt-2 sm:bottom-5 sm:left-auto sm:right-4 sm:w-[22rem] sm:max-w-[calc(100vw-2rem)] sm:px-0 sm:pb-0 sm:pt-0",
