...
values
  (
    ...
    'partner_pro',
    false,
    jsonb_build_object('pilot', true, 'internal_only', true, 'rail', 'affiliate_events'),
    'Interner Pilotdatensatz fuer Ticket-/Event-Weiterleitungen. Kein oeffentlich kommuniziertes Live-Partnerverhaeltnis.'
  ),
  (
    'pilot-andechser-am-dom',
    'Andechser am Dom',
    'Andechser am Dom GmbH',
    'restaurant',
    ...
    'Interner Pilotdatensatz fuer Restaurant-/Reservierungs-Weiterleitungen. Kein oeffentlich kommuniziertes Live-Partnerverhaeltnis.'
  )
...
where program_code in ('internal_pilot_restaurant', 'internal_pilot_event');
...
values (
  (select id from public.partner_profiles where slug = 'pilot-andechser-am-dom'),
  (
    select id
    from public.locations
    where city_slug = 'muenchen'
      and name = 'Andechser am Dom'
      and reservation_url = 'https://www.andechser-am-dom.de/'
