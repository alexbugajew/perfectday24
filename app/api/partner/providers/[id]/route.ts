/**
 * DELETE /api/partner/providers/[id]
 * Deletes a service_providers entry that belongs to the caller's partner_profile.
 * Also deletes all linked provider_packages (cascade or manual).
 */
...
export async function DELETE(
  ...
  // Delete packages first (in case no cascade is set)
  await admin.from("provider_packages").delete().eq("provider_id", id);
